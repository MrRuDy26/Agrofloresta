...
import { ProjectData, Consortium, Plant, Recommendations } from './types';
import { PLANTS_DB } from './constants';
import { 
  Leaf, 
  Sprout, 
  MapPin, 
...
// --- COMPONENTE 1: INPUT FORM (Agora em m²) ---
...
// --- COMPONENTE 2: RESULTS (Com Box Preto e Prompt) ---
  ...
  const generateConsortium = () => {
    ...
    setTimeout(() => {
      ...
      const pickBest = (stratum: string): Plant => {
        ...
        if (candidates.length === 0) return { id: 'gen', name: 'Nativa Local', stratum, function: 'Biomassa', suitableRegions: [], lifecycle: 'PERENE' };
        return candidates[0];
      };
